...
# Install curl, gettext-base (envsubst) and download the Minecraft server JAR
...
# Copy server properties template for runtime config generation
COPY server.properties.template /app/
